		...
		modalRef.result.then((filterLoaded) => {
			if(filterLoaded) {
				...
				this.filterGroup.patchValue({
					...
					gnomADfrom: filterLoaded.gnomADfrom ? filterLoaded.gnomADfrom : null,
					gnomADto: filterLoaded.gnomADto ? filterLoaded.gnomADto : [''],
					readDepthSign: filterLoaded.readDepthSign ? filterLoaded.readDepthSign : '',
					readDepth: filterLoaded.readDepth ? filterLoaded.readDepth : null,
					AFSign: filterLoaded.AFSign ? filterLoaded.AFSign : '',
					alleleFraction: filterLoaded.alleleFraction ? filterLoaded.alleleFraction : null,
					gnomAdSign: filterLoaded.gnomAdSign ? filterLoaded.gnomAdSign : '',
					gnomAd: filterLoaded.gnomAd ? filterLoaded.gnomAd : null,
