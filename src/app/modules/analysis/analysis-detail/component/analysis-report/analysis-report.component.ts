...
export class AnalysisReportComponent implements OnInit  {
	...
	ngOnInit(): void {
		...
		if (this.type == 'fastq') {
			...
			this.isLoading = true;
			this.url = `http://34.212.158.169//vcf/index.html?vcf=https://varigenes-s3.s3.us-west-2.amazonaws.com/samples/sample${this.id}/output-hc-v1.vcf.gz&species=Human&build=GRCh37`
